        ...
        {movieScene === 1 && (
          <div className="movie-stage scene-fade-in" key="scene-1">
            <svg width="100%" height="100" viewBox="0 0 360 100" fill="none">
              <line x1="10" y1="88" x2="350" y2="88" stroke="rgba(255, 22, 56, 0.3)" strokeWidth="1.5" strokeDasharray="4 4" />
              
              {/* Local Postbox */}
              <g className="sc1-postbox">
                <rect x="265" y="55" width="5" height="33" fill="#334155" />
                <path d="M250 32 C250 22 260 17 267 17 C274 17 284 22 284 32 V58 H250 V32 Z" fill="#0A0E14" stroke="#FF1638" strokeWidth="2" />
                <rect x="256" y="38" width="22" height="9" rx="1.5" fill="#050709" stroke="rgba(255, 22, 56, 0.6)" strokeWidth="1" />
                <g className="sc1-flag">
                  <line x1="284" y1="48" x2="284" y2="34" stroke="#FF1638" strokeWidth="2" />
                  <rect x="284" y="34" width="8" height="5" fill="#FF1638" rx="1" />
                </g>
              </g>

              {/* Person Walking in to Mail Slot & Returning */}
              <g className="sc1-person">
                <circle cx="20" cy="34" r="7" fill="#FF1638" />
                <path d="M14 31 C14 27 18 25 23 25 C27 25 29 27 29 31 H14 Z" fill="#FFFFFF" />
                <path d="M13 43 C13 41 16 40 19 40 C22 40 25 41 25 43 V68 H13 Z" fill="#0F141C" stroke="#FF1638" strokeWidth="1.5" />
                <line x1="15" y1="68" x2="11" y2="86" stroke="#FF1638" strokeWidth="2.5" strokeLinecap="round" className="leg-1" />
                <line x1="23" y1="68" x2="27" y2="86" stroke="#FF1638" strokeWidth="2.5" strokeLinecap="round" className="leg-2" />
                <path d="M19 48 L35 52 L48 46" fill="none" stroke="#FF1638" strokeWidth="2" strokeLinecap="round" className="sc1-arm" />
              </g>

              {/* Envelope in Hand & Dropping in Slot */}
              <g className="sc1-envelope">
                <rect x="42" y="39" width="18" height="12" rx="1.5" fill="#FFFFFF" stroke="#FF1638" strokeWidth="1" />
                <path d="M42 39 L51 45 L60 39" fill="none" stroke="#FF1638" strokeWidth="0.8" />
              </g>
            </svg>
          </div>
        )}
          ...
          <div className="movie-stage scene-fade-in" key="scene-2">
            <svg width="100%" height="100" viewBox="0 0 360 100" fill="none">
              ...
              <g className="sc2-postbox">
                ...
                <path d="M25 44 C25 38 30 34 36 34 C42 34 47 38 47 44 V60 H25 Z" fill="#0A0E14" stroke="#FF1638" strokeWidth="1.5" />
              </g>

              {/* Mail Package Loading into Bus */}
              <g className="sc2-mail-package">
                <rect x="38" y="44" width="18" height="12" rx="1.5" fill="#FFFFFF" stroke="#FF1638" strokeWidth="1.2" />
                <path d="M38 44 L47 50 L56 44" fill="none" stroke="#FF1638" strokeWidth="0.8" />
              </g>

              {/* Giant Cyber Mail Bus with 2 Glass Windows 100% Inside Bus Frame */}
              <g className="sc2-bus">
                {/* Headlight beam */}
                <polygon points="105,52 145,44 145,72 105,64" fill="rgba(255, 22, 56, 0.25)" />
                
                {/* Main Bus Body (Height: 64px, Length: 155px) */}
                <path d="M-40 18 H70 L105 42 V82 H-50 V28 Z" fill="#0A0E14" stroke="#FF1638" strokeWidth="2.5" />
                <path d="M-38 22 H68 L98 42 V78 H-46 V30 Z" fill="#0F141C" />

                {/* 2 Glass Windows (Safely inside flat roof section x=32 and x=-10) */}
                <rect x="32" y="24" width="32" height="20" fill="#1E293B" stroke="rgba(255, 22, 56, 0.85)" strokeWidth="1.5" rx="2" />
                <rect x="-10" y="24" width="32" height="20" fill="#1E293B" stroke="rgba(255, 22, 56, 0.85)" strokeWidth="1.5" rx="2" />

                {/* Big Cyber Bus Title */}
                <text x="-24" y="64" fill="#FF1638" fontSize="10.5" fontWeight="900" fontFamily="sans-serif" letterSpacing="1">
                  BSIDES MAIL BUS
                </text>
                <line x1="-36" y1="70" x2="80" y2="70" stroke="#FF1638" strokeWidth="1.5" strokeDasharray="6 3" />

                {/* Solid Heavy Dual Wheels (Anchored directly to bus chassis) */}
                <g>
                  <circle cx="-16" cy="83" r="9" fill="#0A0E14" stroke="#FF1638" strokeWidth="2.2" />
                  <circle cx="-16" cy="83" r="4" fill="#1E293B" stroke="#FFFFFF" strokeWidth="1" />
                </g>
                <g>
                  <circle cx="68" cy="83" r="9" fill="#0A0E14" stroke="#FF1638" strokeWidth="2.2" />
        ...
        {movieScene === 3 && (
          <div className="movie-stage scene-fade-in" key="scene-3">
            <svg width="100%" height="100" viewBox="0 0 360 100" fill="none">
              ...
              <path d="M0 75 L30 50 L65 68 L110 42 L160 62 L220 38 L275 60 L325 35 L360 55 V95 H0 Z" fill="rgba(255, 22, 56, 0.12)" />
              ...
              <g className="sc3-airplane">
                <path d="M0 16 L28 6 L44 16 L34 24 L8 26 Z" fill="#0F141C" stroke="#FF1638" strokeWidth="1.8" />
                <path d="M16 16 L10 0 L22 14" fill="#FF1638" />
                <path d="M18 20 L12 32 L26 22" fill="rgba(255, 22, 56, 0.7)" />
                <polygon points="28,6 36,11 30,14" fill="#FFFFFF" opacity="0.9" />
                <path d="M-4 14 L-12 16 L-4 18 Z" fill="#FF1638" className="thruster-glow" />

                {/* Mail Package Container in Plane Cargo */}
                <rect x="14" y="14" width="12" height="7" rx="1" fill="#FFFFFF" stroke="#FF1638" strokeWidth="0.8" />
              </g>
            </svg>
          </div>
        )}
        ...
        {movieScene === 4 && (
          <div className="movie-stage scene-fade-in" key="scene-4">
            <svg width="100%" height="100" viewBox="0 0 360 100" fill="none">
              ...
              <g className="sc4-bus">
                <path d="M-140 18 H-30 L5 42 V82 H-150 V28 Z" fill="#0A0E14" stroke="#FF1638" strokeWidth="2.5" />
                <path d="M-138 22 H-32 L-2 42 V78 H-146 V30 Z" fill="#0F141C" />
                <rect x="-68" y="24" width="32" height="20" fill="#1E293B" stroke="rgba(255, 22, 56, 0.85)" strokeWidth="1.5" rx="2" />
                <rect x="-110" y="24" width="32" height="20" fill="#1E293B" stroke="rgba(255, 22, 56, 0.85)" strokeWidth="1.5" rx="2" />
                <text x="-124" y="64" fill="#FF1638" fontSize="10.5" fontWeight="900" fontFamily="sans-serif" letterSpacing="1">
                  BSIDES MAIL BUS
                </text>
                <circle cx="-116" cy="83" r="9" fill="#0A0E14" stroke="#FF1638" strokeWidth="2.2" />
                <circle cx="-32" cy="83" r="9" fill="#0A0E14" stroke="#FF1638" strokeWidth="2.2" />
              </g>

              {/* BSides Dharamshala HQ Building (Right side) */}
              <g className="sc4-hq">
                <rect x="245" y="42" width="95" height="46" fill="#0A0E14" stroke="#FF1638" strokeWidth="2" rx="2" />
                <rect x="268" y="24" width="50" height="18" fill="#0F141C" stroke="rgba(255, 22, 56, 0.6)" strokeWidth="1" />
                <line x1="293" y1="24" x2="293" y2="12" stroke="#FF1638" strokeWidth="2" />
                <circle cx="293" cy="10" r="3.5" fill="#FF1638" className="hq-beacon" />

                {/* Entrance Door */}
                <rect x="280" y="64" width="26" height="24" rx="1" fill="#15050A" stroke="#FF1638" strokeWidth="1.5" />

                <text x="292.5" y="52" fill="#FF1638" fontSize="8" fontWeight="900" fontFamily="sans-serif" textAnchor="middle">
                  BSIDES
                </text>
              ...
              <g className="sc4-courier">
                <circle cx="160" cy="38" r="6" fill="#FF1638" />
                <path d="M154 36 C154 33 158 31 163 31 C167 31 169 33 169 36 H154 Z" fill="#FFFFFF" />
                <path d="M153 45 C153 43 156 42 159 42 C162 42 165 43 165 45 V68 H153 Z" fill="#0F141C" stroke="#FF1638" strokeWidth="1.2" />
                <line x1="155" y1="68" x2="152" y2="86" stroke="#FF1638" strokeWidth="2" strokeLinecap="round" className="leg-1" />
                <line x1="162" y1="68" x2="165" y2="86" stroke="#FF1638" strokeWidth="2" strokeLinecap="round" className="leg-2" />
                <path d="M159 48 L175 52 L190 46" fill="none" stroke="#FF1638" strokeWidth="1.8" strokeLinecap="round" />

                {/* Mail Package in Hand */}
                <g className="sc4-package">
                  <rect x="180" y="42" width="20" height="14" rx="1.5" fill="#FFFFFF" stroke="#FF1638" strokeWidth="1.2" />
                  <path d="M180 42 L190 49 L200 42" fill="none" stroke="#FF1638" strokeWidth="1" />
                  <line x1="184" y1="50" x2="196" y2="50" stroke="#FF1638" strokeWidth="1" strokeLinecap="round" />
                </g>
              </g>

              {/* Celebratory Sparkle Burst on HQ Landing */}
              <g className="sc4-sparkles">
                <circle cx="293" cy="35" r="3.5" fill="#FF1638" className="hq-sparkle hs1" />
                <circle cx="270" cy="30" r="3" fill="#FFFFFF" className="hq-sparkle hs2" />
                <circle cx="320" cy="32" r="3" fill="#FF1638" className="hq-sparkle hs3" />
    ...
    <div className={`interactive-envelope-wrap ${isHovered ? 'is-envelope-hovered' : ''}`} aria-label="Mail Envelope">
      <svg width="76" height="60" viewBox="0 0 76 60" fill="none" className="envelope-svg">
        ...
        <g className={`envelope-letter-paper ${isHovered ? 'letter-slide-up' : ''}`}>
          ...
          <line x1="20" y1="26" x2="42" y2="26" stroke="#FF1638" strokeWidth="2" strokeLinecap="round" />
          ...
          <circle cx="53" cy="26" r="2.5" fill="#FF1638" />
        </g>
